...
Status: Accepted (supersedes the "round-robin" wording in `roadmap.md` and `phase3/phase3_minimal_kernel.md`; tracked by #38)
...
- `roadmap.md` and `phase3_minimal_kernel.md` still say "round-robin" and must be corrected.
